...
You need either a Ubuntu or Debian based system for leb.fmvz.usp.br, enable SSH, and install a supported version of Python 3 on that system.
...
Deploy the stack defined in `devops/stacks/leb.fmvz.usp.br.yml` to the remote server with:

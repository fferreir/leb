...
linkcheck_ignore = [
    ...
    r"https://github.com/fferreir/leb/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "repository_url": "https://github.com/fferreir/leb",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/fferreir/leb/edit/main/docs/",
# }
...
ogp_site_name = "LEB Documentation"
ogp_type = "website"
...
htmlhelp_basename = "LEBDocumentation"
